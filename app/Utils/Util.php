...
class Util
{
    ...
    {
        $thousand_separator = ! empty($business_details) ? $business_details->thousand_separator : \Arr::get(session('currency'), 'thousand_separator', ',');
        $decimal_separator = ! empty($business_details) ? $business_details->decimal_separator : \Arr::get(session('currency'), 'decimal_separator', '.');
        ...
        if ($add_symbol) {
            ...
            $symbol = ! empty($business_details) ? $business_details->currency_symbol : \Arr::get(session('currency'), 'symbol', 'Rp');
