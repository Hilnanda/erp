    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        {!! Form::checkbox('common_settings[enable_purchase_print_shipping_details]', 1, !empty($common_settings['enable_purchase_print_shipping_details']) , [ 'class' => 'input-icheck', 'id' => 'enable_purchase_print_shipping_details']); !!} {{ __( 'lang_v1.enable_purchase_print_shipping_details' ) }}
                    </label>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-12">
            <div class="form-group" style="padding-left: 20px;">
                {!! Form::label('purchase_print_signs', 'Tempat Tanda Tangan:') !!}
                @show_tooltip('[Atas]:[Bawah] => contoh: Supplier:Rudi,Finance:Alex')
                {!! Form::text('common_settings[purchase_print_signs]', $common_settings['purchase_print_signs'] ?? '', ['class' => 'form-control', 'id' => 'purchase_print_signs']); !!}
            </div>
        </div>
    </div>
</div>