...
@php
$col_size = $is_download ? 'col' : 'col-xs';
@endphp
<div class="row" style="color: #000000 !important;">
		...
		@if(empty($receipt_details->letter_head))
			@if(!empty($receipt_details->logo))
				@if($is_download)
				<div class="{{$col_size}}-12 text-center">
					<img style="max-height: 120px; width: auto;" src="{{$receipt_details->logo_abs}}" class="img img-responsive center-block">
				</div>
				@else
	...
	<div class="{{$col_size}}-12 text-center">
		<!-- Invoice  number, Date  -->
		<table class="table table-borderless mb-0" style="border-width: 0px;">
			<tbody style="border-width: 0px;">
				<tr style="border-width: 0px;">
					<td class="text-left" style="border-width: 0px;">
						<span class="text-left word-wrap">
					...
					<td class="text-right" style="border-width: 0px;">
...
<div class="row" style="color: #000000 !important;">
	<div class="{{$col_size}}-12">
		...
		<table class="table table-responsive table-slim">
			<thead>
				<tr>
					<th width="{{$p_width}}%" style="text-align: left !important;">{{$receipt_details->table_product_label}}</th>
...
<div class="row" style="color: #000000 !important;">
	...
	@if($receipt_details->show_barcode || $receipt_details->show_qr_code)
		<div class="@if(!empty($receipt_details->footer_text)) {{$col_size}}-4 @else {{$col_size}}-12 @endif text-center">
