...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone'])->group(function () {
    ...
    Route::get('/sells/{activity_log_id}/retry-send-whatsapp-notification', [SellPosController::class, 'retrySendWhatsappNotification'])->name('sell.retrySendWhatsappNotification');
